      ...
      {sports.map((team: sportTypes) => (
        ...
        >
          <div className="flex flex-col">
            <span className="w-full flex justify-center text-sm uppercase">
              {team.country}
            </span>
            <span className="w-full flex justify-center text-xl">
              {team.competition}
            </span>
            <span
              className={clsx({
          ...
          <div className="w-full flex gap-2 justify-center items-center">
            <span className="text-5xl">{team.homeScore.current ?? 0}</span>-
            <span className="text-5xl">{team.awayScore.current ?? 0}</span>
          </div>
          <div className="w-full flex gap-2 justify-between items-center">
            <span className="text-base md:text-2xl md:w-[30rem] flex justify-center">
              {team.homeTeam.name}
            </span>
